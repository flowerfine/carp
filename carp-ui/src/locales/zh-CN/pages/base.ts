export default {
  ...
  'app.common.operate.import.label': '导入',
  'app.common.operate.import.success': '导入成功',
  'app.common.operate.import.failure': '导入失败',
  'app.common.operate.export.label': '导出',
  'app.common.operate.export.success': '导出成功',
  'app.common.operate.export.failure': '导出失败',
  ...
  'app.common.operate.enable.success': '启用成功',
  'app.common.operate.disable.label': '禁用',
  'app.common.operate.disable.success': '禁用成功',
  'app.common.operate.copy.label': '复制',
  'app.common.operate.copy.success': '复制成功',
  'app.common.operate.cut.label': '剪切',
