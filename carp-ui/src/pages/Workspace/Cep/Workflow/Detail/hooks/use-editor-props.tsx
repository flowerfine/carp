...
const INITIAL_DATA: FlowDocumentJSON = { nodes: [], edges: [], globalVariable: {} };

export function useEditorProps(
  nodeRegistries: FlowNodeRegistry[],
  record: WorkspaceCepAPI.CepWorkflow
): FreeLayoutProps {
  return useMemo<FreeLayoutProps>(
    () => ({
      ...
      onContentChange: debounce((ctx: FreeLayoutPluginContext, event) => {
        ...
        const param: WorkspaceCepAPI.CepWorkflowUpdateParam = {
          id: record.id,
        ...
        CepWorkflowService.update(param);
        console.log('Auto Save: ', event, param);
      ...
      plugins: () => [
         ...
         */
        createVariablePanelPlugin({
          initialData: INITIAL_DATA.globalVariable,
        }),
        /** Float layout plugin */
        createPanelManagerPlugin(),
      ],
