...
export class WorkflowSaveService {
  ...
  loadWorkflowJson = async () => {
    ...
    let workflowJson: WorkflowJSON | undefined = await this.globalState.load(workflowId);
    // let workflowJson: WorkflowJSON | undefined = await fetch('/data/flowgram/demo-test-run.json')
