import {Cell, Graph, Node, Path, useGraphInstance} from "@antv/xflow";
import Hierarchy from '@antv/hierarchy'
import insertCss from 'insert-css'

const MIND_NODE = 'topic';
const MIND_CHILD_NODE = 'topic-child';
const MIND_EDGE = 'mindmap-edge';
const MIND_CONNECTOR = 'mindmap';
...
const X6MindNode = ({node}: { node: Node }) => {
    ...
    const traverse = (hierarchyItem: HierarchyResult) => {
      if (hierarchyItem) {
        ...
        cells.push(
          graph?.createNode({
            id: data.id,
            shape: data.type === "topic-child" ? MIND_CHILD_NODE : MIND_NODE,
            x: hierarchyItem.x,
            y: hierarchyItem.y,
            width: data.width,
            height: data.height,
