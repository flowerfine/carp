...
@FunctionalInterface
public interface InternalWorkflowTaskInstanceStatusEventBuilder {

    InternalWorkflowTaskInstanceStatusEvent build(
            CarpWorkflowTaskInstanceState state,
            CarpWorkflowTaskInstanceState nextState,
            CarpWorkflowTaskInstanceEvent event);
}
