...
import cn.sliew.carp.plugin.workflow.engine.internal.api.engine.dispatch.WorkflowStepInstanceEventDispatcher;
import cn.sliew.carp.plugin.workflow.engine.internal.api.engine.dispatch.event.WorkflowStepInstanceStatusEvent;
...
import cn.sliew.carp.plugin.workflow.engine.internal.core.engine.dispatch.handler.step.InternalStepEventListener;
...
public class InternalWorkflowStepInstanceEventDispatcher implements WorkflowStepInstanceEventDispatcher, MessageHandler<CommonMessage>, InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        executor.setThreadNamePrefix("workflow-step-instance-thread-pool-");
        executor.initialize();
    ...
    @Override
    public void dispatch(WorkflowStepInstanceStatusEvent event) {
