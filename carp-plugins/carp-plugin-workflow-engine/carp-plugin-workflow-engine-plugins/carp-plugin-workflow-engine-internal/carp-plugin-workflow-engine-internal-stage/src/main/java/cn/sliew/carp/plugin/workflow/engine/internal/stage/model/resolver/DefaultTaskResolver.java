 ...
 */
package cn.sliew.carp.plugin.workflow.engine.internal.stage.model.resolver;
...
public class DefaultTaskResolver implements TaskResolver {
    ...
    public DefaultTaskResolver(List<Task> tasks, boolean allowFallback) {
    ...
    private void addMissingTasksFromTaskProvider() {
        for (Task task : SpringUtil.getBeansOfType(Task.class).values()) {
