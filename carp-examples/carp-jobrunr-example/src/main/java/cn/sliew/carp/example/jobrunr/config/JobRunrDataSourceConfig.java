...
public class JobRunrDataSourceConfig {
    ...
    @Primary
    @Bean("jobRunrTransactionManager")
    public DataSourceTransactionManager jobRunrTransactionManager() {
        return new DataSourceTransactionManager(jobRunrDataSource());
    }
