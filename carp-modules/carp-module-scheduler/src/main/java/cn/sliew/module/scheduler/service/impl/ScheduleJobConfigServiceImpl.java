...
import cn.sliew.module.scheduler.repository.mapper.ScheduleJobConfigMapper;
import cn.sliew.module.scheduler.service.ScheduleJobConfigService;
import cn.sliew.module.scheduler.service.convert.ScheduleJobConfigConvert;
...
public class ScheduleJobConfigServiceImpl extends ServiceImpl<ScheduleJobConfigMapper, ScheduleJobConfig> implements ScheduleJobConfigService {
    ...
    public ScheduleJobConfigDTO get(Long id) {
        ScheduleJobConfig entity = getOptById(id).orElseThrow(() -> new IllegalArgumentException("schedule job config not exists for id: " + id));
