 ...
 */
package cn.sliew.carp.module.scheduler.executor.orca;
...
@Slf4j
public class OrcaJobExecutor implements JobExecutor {

    @Override
    public List<CarpScheduleEngineType> getEngines() {
        return Collections.singletonList(CarpScheduleEngineType.ORCA);
    }
