...
public abstract class AbstractJobHandlerFactory implements JobHandlerFactory {
    ...
    @Override
    public JobHandler newInstance(String jobHandler) {
        return cache.computeIfAbsent(jobHandler, key -> create(key));
    }

    protected abstract JobHandler create(String jobHandler);
