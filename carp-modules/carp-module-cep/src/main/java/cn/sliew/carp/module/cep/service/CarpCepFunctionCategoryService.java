...
public interface CarpCepFunctionCategoryService extends IService<CarpCepFunctionCategory> {

    List<CarpCepFunctionCategoryDTO> listAll(CepFunctionCategoryListParam param);
}
