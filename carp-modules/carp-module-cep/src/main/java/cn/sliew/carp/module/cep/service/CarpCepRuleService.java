...
public interface CarpCepRuleService extends IService<CarpCepRule> {

    PageResult<CarpCepRuleDTO> page(CepRulePageParam param);

    CarpCepRuleDTO get(Long id);

    boolean add(CepRuleAddParam param);

    boolean update(CepRuleUpdateParam param);
