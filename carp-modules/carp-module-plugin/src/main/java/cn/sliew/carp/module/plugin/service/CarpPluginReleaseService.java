...
public interface CarpPluginReleaseService extends IService<CarpPluginRelease> {
    ...
    PageResult<CarpPluginReleaseDTO> page(CarpPluginReleasePageParam param);

    List<CarpPluginReleaseDTO> list(CarpPluginReleasePageParam param);

    CarpPluginReleaseDTO get(Long id);

    CarpPluginReleaseDTO getByUuid(String pluginUuid);

    Path internalDownloadPlugin(CarpPluginReleaseDTO dto) throws IOException;
