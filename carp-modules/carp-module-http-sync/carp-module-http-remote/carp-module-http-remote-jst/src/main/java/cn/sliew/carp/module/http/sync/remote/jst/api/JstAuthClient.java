...
public interface JstAuthClient {
    ...
    JstNewResult<JstAccessTokenDO> accessToken(URI uri, @SpringQueryMap Map<String, String> params);
    ...
    JstNewResult<JstAccessTokenDO> refreshToken(URI uri, @RequestBody String paramStr);
}
