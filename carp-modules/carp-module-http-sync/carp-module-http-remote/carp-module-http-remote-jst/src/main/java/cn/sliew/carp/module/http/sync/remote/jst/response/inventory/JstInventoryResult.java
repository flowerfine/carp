...
@Getter
@Setter
public class JstInventoryResult extends JstResult<InventoryDO> {

    @JsonIgnoreProperties(allowGetters = false, allowSetters = true)
    private List<InventoryDO> inventorys;

    @Override
    public List<InventoryDO> getDatas() {
        return inventorys;
    }

    @Override
    public void setDatas(List<InventoryDO> datas) {
