...
public interface JstBaseClient {
    ...
    JstNewResult<JstResult<ShopDO>> getShops(URI uri, @RequestBody String paramStr);
    ...
    JstNewResult<JstResult<WmsPartnerDO>> getWmsPartner(URI uri, @RequestBody String paramStr);
}
