...
public abstract class AbstractJstRootTask<Sub extends AbstractJstSubTask> implements RootTask<SimpleJobContext, Sub> {

    private Long rootTaskId;

    public AbstractJstRootTask(Long rootTaskId) {
