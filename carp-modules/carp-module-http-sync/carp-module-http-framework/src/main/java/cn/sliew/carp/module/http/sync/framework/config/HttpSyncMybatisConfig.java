 ...
 */
package cn.sliew.carp.module.http.sync.framework.config;
...
@MapperScan(sqlSessionFactoryRef = DataSourceConstants.SQL_SESSION_FACTORY,
        basePackages = {HttpSyncMybatisConfig.MAPPER_MODULE_HTTP_SYNC_PACKAGE})
public class HttpSyncMybatisConfig {
