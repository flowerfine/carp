...
public interface AlertRuleService extends IService<CarpAlertRule> {

    PageResult<CarpAlertRuleDTO> page(AlertRulePageParam param);

    CarpAlertRuleDTO get(Long id);

    boolean add(AlertRuleAddParam param);

    boolean update(AlertRuleUpdateParam param);
