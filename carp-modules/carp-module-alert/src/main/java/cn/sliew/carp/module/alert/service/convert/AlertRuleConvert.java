...
@Mapper
public interface AlertRuleConvert extends BaseConvert<CarpAlertRule, CarpAlertRuleDTO> {
    AlertRuleConvert INSTANCE = Mappers.getMapper(AlertRuleConvert.class);
}
