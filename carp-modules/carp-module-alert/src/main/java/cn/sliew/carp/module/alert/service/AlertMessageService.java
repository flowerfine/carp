...
public interface AlertMessageService extends IService<CarpAlertMessage> {

    PageResult<CarpAlertMessageDTO> page(AlertMessagePageParam param);

    CarpAlertMessageDTO get(Long id);

    boolean receive(AlertMessageReceiveParam param);

    boolean delete(Long id);

    boolean deleteBatch(Collection<Long> ids);

    boolean deleteByRule(String namespace, String ruleId);
}
