...
public interface SystemInfoApi {
    ...
    @GetMapping(value = "/api/v1/system_info")
    ResponseEntity<V1SystemInfoResponse> getSystemInfo();

    @PutMapping(value = "/api/v1/system_info")
    ResponseEntity<V1SystemInfoResponse> updateSystemInfo(@RequestBody V1SystemInfoRequest body);
