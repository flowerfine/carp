...
import cn.sliew.carp.module.workflow.engine.internal.api.engine.dispatch.event.WorkflowLevel;
import cn.sliew.carp.module.workflow.engine.internal.api.engine.dispatch.event.WorkflowStepLevel;
import cn.sliew.carp.module.workflow.engine.internal.api.engine.dispatch.event.WorkflowStepTaskLevel;
...
import cn.sliew.carp.module.workflow.engine.internal.stage.model.repository.WorkflowRepository;
...
public interface WorkflowMessageHandler<M> {
        ...
        withWorkflow(stepLevel, dagInstanceDTO -> {
            try {
                ...
                getLog().error("Failed to locate step with id: {}, workflowInstanceId: {}",
                        stepLevel.getStepId(), stepLevel.getWorkflowInstanceId(), e);
