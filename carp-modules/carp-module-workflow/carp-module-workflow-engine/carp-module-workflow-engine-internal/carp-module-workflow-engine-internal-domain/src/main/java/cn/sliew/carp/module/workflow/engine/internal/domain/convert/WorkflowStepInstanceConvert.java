...
import cn.sliew.carp.module.workflow.engine.internal.domain.instance.WorkflowStepInstanceBody;
...
public interface WorkflowStepInstanceConvert extends BaseConvert<DagStepDTO, WorkflowStepInstance> {
    ...
    default DagStepDTO toDo(WorkflowStepInstance dto) {
        ...
        if (Objects.nonNull(dto.getContext())) {
            entity.setContext(JacksonUtil.toJsonNode(dto.getContext()));
        }
    ...
    default WorkflowStepInstance toDto(DagStepDTO entity) {
        ...
        if (Objects.nonNull(entity.getBody())
            ...
            dto.setBody(JacksonUtil.toObject(entity.getBody(), WorkflowStepInstanceBody.class));
        }
