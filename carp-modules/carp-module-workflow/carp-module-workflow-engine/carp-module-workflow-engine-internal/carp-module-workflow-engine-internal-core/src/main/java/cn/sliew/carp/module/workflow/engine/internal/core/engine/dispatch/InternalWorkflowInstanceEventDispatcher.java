 ...
 */
package cn.sliew.carp.module.workflow.engine.internal.core.engine.dispatch;
...
import cn.sliew.carp.module.workflow.engine.internal.api.engine.dispatch.WorkflowInstanceEventDispatcher;
import cn.sliew.carp.module.workflow.engine.internal.api.engine.dispatch.event.WorkflowInstanceStatusEvent;
import cn.sliew.carp.module.workflow.engine.internal.core.engine.dispatch.event.InternalWorkflowInstanceStatusEvent;
import cn.sliew.carp.module.workflow.engine.internal.core.engine.dispatch.handler.workflow.InternalWorkflowEventListener;
...
public class InternalWorkflowInstanceEventDispatcher implements WorkflowInstanceEventDispatcher, MessageHandler<CommonMessage>, InitializingBean, DisposableBean {
    ...
    public void handle(CommonMessage message) {
        if (message.getBody() != null) {
            ...
            if (messageBody instanceof InternalWorkflowInstanceStatusEvent eventDTO) {
                dispatch(eventDTO);
            } else {
                throw new UnsupportedOperationException();
            }
    ...
    public void dispatch(WorkflowInstanceStatusEvent event) {
        ...
        CompletableFuture.runAsync(() -> handler.handle((InternalWorkflowInstanceStatusEvent) event), taskExecutor)
