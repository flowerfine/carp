...
@Slf4j
public abstract class AbstractStepEventListener<T extends InternalWorkflowStepInstanceStatusEvent> implements InternalStepEventListener<T>, InitializingBean, BeanFactoryAware {
    ...
    @Autowired
    protected InternalWorkflowInstanceStateMachine instanceStateMachine;
    @Autowired
    protected InternalWorkflowStepInstanceStateMachine stateMachine;
    @Autowired
    protected InternalWorkflowTaskInstanceManager taskInstanceManager;
    @Autowired
