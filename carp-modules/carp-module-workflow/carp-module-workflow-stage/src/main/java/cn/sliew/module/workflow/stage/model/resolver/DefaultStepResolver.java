...
public class DefaultStepResolver implements StepResolver {
    ...
    public DefaultStepResolver(ObjectProvider<Collection<StageDefinitionBuilder>> stageDefinitionBuildersProvider) {
        this.stageDefinitionBuildersProvider = stageDefinitionBuildersProvider;
        var stageDefinitionBuilders = stageDefinitionBuildersProvider.getIfAvailable(ArrayList::new);
    ...
    private void addMissingStepsFromStepProvider() {
        for (StageDefinitionBuilder stageDefinitionBuilder : stageDefinitionBuildersProvider.getIfAvailable(ArrayList::new)) {
