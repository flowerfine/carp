...
public class CarpGravitinoMetalakeController {
    ...
    @GetMapping("{metalake}/catalogs/{catalog}/schemas/{schema}/tables/{table}")
    @Operation(summary = "查询 table", description = "查询 table")
    public GravitinoTableDTO getTable(@PathVariable("metalake") String metalake,
                                      @PathVariable("catalog") String catalog,
                                      @PathVariable("schema") String schema,
                                      @PathVariable("table") String table) {
        return carpGravitinoMetalakeService.getTable(metalake, catalog, schema, table);
    }
}
