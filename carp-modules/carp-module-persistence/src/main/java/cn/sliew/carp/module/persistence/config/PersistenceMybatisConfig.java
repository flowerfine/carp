 ...
 */
package cn.sliew.carp.module.persistence.config;
...
public class PersistenceMybatisConfig {
    ...
    public static final String MAPPER_MODULE_PERSISTENCE_PACKAGE = "cn.sliew.carp.module.persistence.sql.mapper";
}
