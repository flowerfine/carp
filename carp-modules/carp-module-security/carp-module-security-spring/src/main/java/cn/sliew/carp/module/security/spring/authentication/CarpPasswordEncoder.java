...
public class CarpPasswordEncoder implements PasswordEncoder {
    ...
    public boolean matches(CharSequence rawPassword, String encodedPassword) {
        ...
        String originPassword = passwordStr.substring(0, passwordStr.indexOf(SPLIT));
        String salt = passwordStr.substring(passwordStr.indexOf(SPLIT) + 1, passwordStr.length());
        return PasswordUtil.checkPassword(originPassword, encodedPassword, salt);
    }
}
