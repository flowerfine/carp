...
public interface SecDeptService extends IService<SecDept> {

    PageResult<SecDeptDTO> page(SecDeptListParam param);

    List<SecDeptDTO> listAll(SecDeptListParam param);

    SecDeptDTO get(Long id);

    boolean add(SecDeptDTO param);

    boolean update(SecDeptDTO param);
