...
public abstract class BaseQueue implements Queue {
    ...
    public BaseQueue(String name, ListenerManager listenerManager) {
        this.name = name;
    ...
    public void register(String consumerGroup, MessageHandler handler) {
        listenerManager.register(getName(), consumerGroup, handler);
    }

    @Override
    public void remove(String consumerGroup, MessageHandler handler) {
        listenerManager.remove(getName(), consumerGroup, handler);
    }
}
