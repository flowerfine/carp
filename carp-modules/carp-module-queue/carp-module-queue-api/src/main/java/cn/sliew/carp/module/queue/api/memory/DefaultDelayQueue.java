...
public class DefaultDelayQueue extends BaseQueue {
    ...
    public DefaultDelayQueue(String name, ListenerManager listenerManager) {
    ...
    public void push(Message message, Duration delay) {
        MessageTask messageTask = new MessageTask(message, listenerManager);
        timer.newTimeout(messageTask, message.getBackoffMills(), TimeUnit.MILLISECONDS);
    }
}
